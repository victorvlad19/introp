...
void Lungime (){
    ...
    cout << "*-|     Lungime           --*" << endl;
    cout << "*---------------------------*" << endl;
    cout << "1. Metrii (m): " << endl;
    cout << "2. Centimetrii (cm): " << endl;
...
void Metrii () {
    ...
    cout << "Inchi (in): " << valoareMetrii/0.0254 << endl;
    cout << "Centimetrii (cm): " << valoareMetrii/0.010000 << endl;
    cout << "Milimetrii (mm): " << valoareMetrii/0.0010000 << endl;
    cout << "Kilometrii (km): " << valoareMetrii/1000.0 << endl;
...
void Centimetrii () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Inchi (in): " << valoareCentimetrii*0.39370 << endl;
    cout << "Metrii (m): " << valoareCentimetrii/100.00 << endl;
    cout << "Milimetrii (mm): " << valoareCentimetrii/0.10000 << endl;
    cout << "Kilometrii (km): " << valoareCentimetrii/100000 << endl;
...
void Arie (){
    ...
    cout << "*-|     Arie              --*" << endl;
    cout << "*---------------------------*" << endl;
    cout << "1. Hectare (ha): " << endl;
    cout << "2. Metrii patrati (m^2): " << endl;
    cout << "3. Inapoi la meniu " << endl;
    cout << "4. Exit" << endl;
    cout << "*---------------------------*" << endl;
    cout << "Alegeti optiunea:" << endl;
...
void Hectare () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Metrii Patrati (m^2): " << valoareHectare*0.00010000 << endl;
    cout << "Kilometrii Patrati (km^2): " << valoareHectare/100.00 << endl;
    cout << "Inchi Patrati (in^2): " << valoareHectare*15500000 << endl;
...
void MetriiPatrati () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Hectare (ha): " << valoareMPatrati/10000 << endl;
    cout << "Kilometrii patrati (km^2): " << valoareMPatrati/1000000 << endl;
    cout << "Inchi patrati (in^2): " << valoareMPatrati*1550 << endl;
...
void Volum (){
    ...
    cout << "*-|     Volum              --*" << endl;
    cout << "*---------------------------*" << endl;
    cout << "1. Litrii (l): " << endl;
    cout << "2. Mililitrii (ml): " << endl;
    cout << "3. Inapoi la meniu " << endl;
    cout << "4. Exit" << endl;
    cout << "*---------------------------*" << endl;
    cout << "Alegeti optiunea:" << endl;
...
void Litrii () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Galoane (gal): " << valoareLitrii*0.26417 << endl;
    cout << "Pinte (pt): " << valoareLitrii*2.1134 << endl;
    cout << "Mililitrii (ml): " << valoareLitrii/0.010000 << endl;
    cout << "Centilitrii (cl): " << valoareLitrii/0.0010000 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Volum();
...
void Mililitrii () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Litrii (l): " << valoareMililitrii/1000.0 << endl;
    cout << "Pinte (pt): " << valoareMililitrii*0.00026417 << endl;
    cout << "Galoane (gal): " << valoareMililitrii*0.0021134 << endl;
    cout << "Centilitrii (cl): " << valoareMililitrii/10.000 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Volum();
...
void Timp (){
    ...
    cout << "*-|     Timp              --*" << endl;
    cout << "*---------------------------*" << endl;
    cout << "1. Secunde (s): " << endl;
    cout << "2. Minute (min): " << endl;
    cout << "3. Ore (h):" << endl;
...
void Secunde () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Minute (min): " << valoareSecunde*0.016667 << endl;
    cout << "Ore (h): " << valoareSecunde*0.00027778 << endl;
    cout << "Zile (d): " << valoareSecunde*0.000011574 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Timp();
...
void Minute () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Secunde (s): " << valoareMinute/0.016667 << endl;
    cout << "Ore (h): " << valoareMinute*0.016667 << endl;
    cout << "Zile (d): " << valoareMinute*0.00069444 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Timp();
...
void Ore () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Secunde (s): " << valoareOre/0.00027778 << endl;
    cout << "Minute (m): " << valoareOre*60.000 << endl;
    cout << "Zile (d): " << valoareOre*0.041667 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Timp();
...
void Viteza (){
    ...
    cout << "*-|     Viteza            --*" << endl;
    cout << "*---------------------------*" << endl;
    cout << "1. Mile pe ora (mi/h): " << endl;
    cout << "2. Kilometrii pe ora (km/h): " << endl;
    cout << "3. Inapoi la meniu " << endl;
    cout << "4. Exit" << endl;
    cout << "*---------------------------*" << endl;
    cout << "Alegeti optiunea:" << endl;
...
void Milepeora(){
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Kilometrii pe ora (km/h): " << valoareMilepeOra/1.609344 << endl;
    cout << "Metrii pe secunda (m/s): " << valoareMilepeOra*0.44704 << endl;
    cout << "Yards pe ora (yd/h): " << valoareMilepeOra*1.760 << endl;
    cout << "Inchi pe ora (in/h): " << valoareMilepeOra*63.360 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Viteza();
...
void Kilometriipeora() {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Centimetrii pe ora (cm/h): " << valoareKilompeora*100.000 << endl;
    cout << "Inchi pe ora (in/h): " << valoareKilompeora/0.0000254 << endl;
    cout << "Metrii pe ora (m/h): " << valoareKilompeora*1.000 << endl;
    cout << "Yards pe ora (yd/h): " << valoareKilompeora/0.0009144 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Viteza();
...
void Celsius (){
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Fahrenheit (F): " << (valoareCelsius * 1.8) + 32 << endl;
    cout << "Kelvin (K): " << valoareCelsius - 273.15 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Temperatura();
...
void Fahrenheit () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Celsius (C): " << ((valoareFahr - 32) * 5) / 9 << endl;
    cout << "Kelvin (K): " << (((valoareFahr - 32) * 5) / 9) + 273.15 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Temperatura();
...
void Grame () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Centigrame (cg): " << valoareGrame * 100 << endl;
    cout << "Decagrame (dag): " << valoareGrame * 10 << endl;
    cout << "Kilograme (kg): " << valoareGrame * 1000 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Masa();
...
void Kilograme () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Centigrame (cg): " << valoareKilograme / 100000 << endl;
    cout << "Decagrame (dag): " << valoareKilograme * 100 << endl;
    cout << "Grame (g): " << valoareKilograme * 1000 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Masa();
...
void Atmosfere(){
    ...
    cout << "Pascali (Pa): " << valoareAtomosfere * 101325 << endl;
    cout << "Kilopascali (kPa) : " << valoareAtomosfere *  101.325 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Presiune();
...
void Bari () {
    ...
    cout << endl;
    cout << "*RASPUNS--------------------*" << endl << endl;
    cout << "Atmosfere (At): " << valoareBari / 1.01325 << endl;
    cout << "Pascali (Pa): " << valoareBari * 100000 << endl;
    cout << "Kilopascali (kPa): " << valoareBari *  100 << endl;
    cout << endl;
    cout << "*---------------------------*" << endl << endl;
    std::this_thread::sleep_for( std::chrono::seconds{1});
    Presiune();
